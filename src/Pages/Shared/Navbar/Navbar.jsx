...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li><NavLink to="/features" className="font-bold text-xl text-white">Features</NavLink></li>
        <li><NavLink to="/booking" className="font-bold text-xl text-white">Book now</NavLink></li>
    </>
